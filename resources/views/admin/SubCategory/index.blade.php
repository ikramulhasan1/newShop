                ...
                <form action="" method="get">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{route('subcategories.index')}}' " class="btn btn-sm btn-outline-danger">Reset</button>
                        </div>
                    ...
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex ">
                                    <a href="{{route('sub-categories.edit', $subcategories->id)}}">
                                        <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                        </svg>
                                    </a>
                                    <a href="#" class="text-danger w-4 h-4 mr-1">
                                        <form action="{{route('sub-categories.destroy', $subcategories->id)}}" method="post">
                                            @method('DELETE')
                                            @csrf
