            ...
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('ui/frontend') }}/images/carousel-1-m.jpg" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('ui/frontend') }}/images/carousel-1.jpg" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('ui/frontend') }}/images/carousel-2-m.jpg" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('ui/frontend') }}/images/carousel-2.jpg" />
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)"
                                srcset="{{ asset('ui/frontend') }}/images/carousel-3-m.jpg" />
                            <source media="(min-width: 800px)"
                                srcset="{{ asset('ui/frontend') }}/images/carousel-3.jpg" />
                            <img src="{{ asset('ui/frontend') }}/images/carousel-2.jpg" alt="" />
                        </picture>
            ...
            <div class="container">
                ...
                <div class="row pb-3">
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                <img src="{{ asset('ui/frontend') }}/images/cat-1.jpg" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="right">
                                <div class="cat-data">
