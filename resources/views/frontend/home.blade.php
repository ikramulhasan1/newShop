        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('ui/frontend') }}/images/carousel-1-m.jpg" />
                        <source media="(min-width: 800px)" srcset="{{ asset('ui/frontend') }}/images/carousel-1.jpg" />
                        <img src="{{ asset('ui/frontend') }}/images/carousel-1.jpg" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('ui/frontend') }}/images/carousel-2-m.jpg" />
                        <source media="(min-width: 800px)" srcset="{{ asset('ui/frontend') }}/images/carousel-2.jpg" />
                        <img src="{{ asset('ui/frontend') }}/images/carousel-2.jpg" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('ui/frontend') }}/images/carousel-3-m.jpg" />
                        <source media="(min-width: 800px)" srcset="{{ asset('ui/frontend') }}/images/carousel-3.jpg" />
                        <img src="{{ asset('ui/frontend') }}/images/carousel-2.jpg" alt="" />
                    </picture>
            ...
            <div class="row pb-3">
                @forelse ($categories as $category)
                    ...
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                <img src="{{ asset('storage/category-images/' . $category->images) }}" alt=""
                                    class="img-fluid p-2">
                            </div>
                            <div class="right">
                                <div class="cat-data">
                ...
                @empty
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                <img src="{{ asset('ui/frontend/images/defult/150x150.png') }}" alt=""
                                    class="img-fluid">
                            </div>
                            <div class="right">
                                <div class="cat-data">
                    ...
                    @empty
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    <a href="" class="product-img"><img class="card-img-top"
                                            src="{{ asset('ui/frontend') }}/images/product-1.jpg" alt=""></a>
                                    <a class="whishlist" href="222"><i class="far fa-heart"></i></a>
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="product.php">{{ $category->products }} </a>
                                    <div class="price mt-2">
